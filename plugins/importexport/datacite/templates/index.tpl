				...
				<div class="pkp_content_panel">
					<fieldset id="exportForm">
								...
								<div class="pkpListPanel__body -pkpClearfix">
									<div class="pkpListPanel__selectAll">
										...
										<div class="pkpListPanelItem__selectItem">
											<input type="checkbox" id="SelectListPanelSelectAll" class="pkpListPanel__selectAllInput">
											<label for="SelectListPanelSelectAll" class="-screenReader">Select All</label>
										</div>
										--->
									</div>
									<div class="pkpListPanel__content">
										<ul aria-live="polite" class="pkpListPanel__items">
											...
											<li class="pkpListPanelItem pkpListPanelItem--select pkpListPanelItem--selectSubmission -clearFix">
												...
												<label for="selectedSubmissions[]79" class="pkpListPanelItem__item">
													<div>{$item["id"]}</div>
													...
													<br>
													<div class="pkpListPanelItem--submission__title">DataCite-Status: {$item["dataCiteStatus"]}</div>
												</label>
												<a href="http://localhost:4444/index.php/dai/workflow/access/{$item["id"]}" target="_blank" class="pkpListPanelItem--submission__link">
						...
						<div class="section formButtons form_buttons ">
							<button class="pkp_button submitFormButton" type="submit" id="submitFormButton">Export</button>
